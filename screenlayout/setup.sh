...
{% if "home" in profiles %}
xrandr --output {{ monitor.wide }} --primary --mode 3440x1440 --pos 1920x0 --rotate normal --rate 100 --output {{ monitor.left }} --auto --pos 0x583 --rotate normal --output {{ monitor.main }} --auto --pos 5360x180 --rotate normal
